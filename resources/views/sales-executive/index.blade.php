...
<div class="space-y-4">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Dashboard Sales Executive</h1>
            <p class="text-sm text-gray-600 mt-1">
                Lihat data customer dan informasi piutang
            </p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 border border-gray-200">
        <form method="GET" action="{{ route('sales-executive.index') }}" id="filterForm" class="space-y-3">
            <div class="flex flex-wrap gap-3">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('sales-executive.index') }}" 
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="{{ route('sales-executive.show', $customer) }}" 
